 ...
 */
@Embeddable
public class KasnjenjePoPlatnojKarticiID implements Serializable{
    private int sifraPlatneKartice;
    private int redniBroj;

    public KasnjenjePoPlatnojKarticiID() {
    }

    public KasnjenjePoPlatnojKarticiID(int sifraPlatneKartice, int redniBroj) {
